                                        ...
                                        <Card fluid>
                                            ...
                                            <Card.Content>
                                                <div style={{overflowX: 'hidden'}}>
                                                    <Link to={{pathname: "/gliasandsynapses-astrocyte"}} className='navText'>
                                            ...
                                            <Card.Content>
                                                <div style={{overflowX: 'hidden'}}>
                                                    <Link to={{pathname: "/gliasandsynapses-oligodendroglia"}} className='navText'>
                                            ...
                                            <Card.Content>
                                                <div style={{overflowX: 'hidden'}}>
                                                    <Link to={{pathname: "/gliasandsynapses-chemical"}} className='navText'>
                                            ...
                                            <Card.Content>
                                                <div style={{overflowX: 'hidden'}}>
                                                    <Link to={{pathname: "/gliasandsynapses-cns"}} className='navText'>
